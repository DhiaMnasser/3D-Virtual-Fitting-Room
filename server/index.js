...
pulls = [
  "https://www.ha.com.tn/femme/sweater/sweat-shirt.html",
...
gilets = [
  "https://www.ha.com.tn/femme/gilet/gilet-court.html",
...
blousons = [
  "https://www.ha.com.tn/homme/outwear/veste.html",
...
manteaus = [
  "https://www.ha.com.tn/femme/manteau-femme-23546.html",
...
chemises = [
  "https://www.ha.com.tn/femme/chemise/chemise-ml.html",
...
shorts = ["https://www.ha.com.tn/femme/short-bermuda.html"];
costumes = ["https://www.ha.com.tn/homme/costume.html"];
chaussures = [
  "https://www.ha.com.tn/homme/chaussures/baskets.html",
...
accessoires = [
  "https://www.ha.com.tn/femme/accessoires/echarpe.html",
...
chaussure = {
  link: ["https://www.exist.com.tn/209-chaussures?page="],
  page: 6
};
accessoire = {
  link: ["https://www.exist.com.tn/212-accessoires?page="],
  page: 9
};
...
//     axios
//       .all([
//         axios.post("https://three-vfr-p.herokuapp.com/exist", {
//           link: ["https://www.exist.com.tn/215-pulls-polos?page="],
//           page: 10
//         }),
//         axios.post("https://three-vfr-p.herokuapp.com/ha", {
//           link: [...pulls, ...pantalons, ...chemises]
//         }),
//         axios.post("https://three-vfr-p.herokuapp.com/exist", {
//           link: ["https://www.exist.com.tn/208-pantalons?page="],
//           page: 4
//         }),
//         axios.post("https://three-vfr-p.herokuapp.com/exist", {
//           link: ["https://www.exist.com.tn/206-chemises?page="],
//           page: 4
//         }),
//         axios.post("https://three-vfr-p.herokuapp.com/exist", {
//           link: ["https://www.exist.com.tn/219-gilets?page="],
//           page: 3
//         })
//       ])
//       .then(res => {
...
//         fs.writeFile("exist.json", json1, "utf8", err => {
//           console.log(err);
//         });
//         fs.writeFile("ha.json", json2, "utf8", err => {
//           console.log(err);
//         });
//       })
