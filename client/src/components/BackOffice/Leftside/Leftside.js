    ...
    return (
      <div>
        ...
        >
          ...
          <li className="nav-item active">
            <Link className="nav-link" to="/admin/listclaim">
              <i className="fas fa-fw fa-tachometer-alt"></i>
              <span>Claims</span>
            </Link>
          </li>
          <li className="nav-item active">
            <Link className="nav-link" to="/admin/listreview">
              <i className="fas fa-fw fa-tachometer-alt"></i>
              <span>Reviews</span>
            </Link>
          </li>
          ...
          <li className="nav-item active">
            <Link className="nav-link" to="/admin/compImg">
              <i className="fas fa-fw fa-tachometer-alt"></i>
              <span>Image Comparater</span>
            </Link>
          </li>
