...
export class AvatarThreeJS extends Component {
  componentDidMount() {
    ...
    // use ref as a mount point of the AvatarThreeJS.js scene instead of the document.body
