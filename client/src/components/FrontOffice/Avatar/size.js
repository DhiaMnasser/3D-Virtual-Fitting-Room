    ...
    function gotPoses(poses) {
      ...
      if (poses.length > 0) {
        ...
        if (pose) {
          ...
          let height =
            ((p.dist(
              rightShoulder.y - 1.25 * d,
              rightShoulder.y - 1.25 * d,
              rightHip.x - d,
              rightHip.y
            ) +
              p.dist(rightHip.x, rightHip.y, rightAnkle.x, rightAnkle.y) +
              p.dist(rightShoulder.x, rightShoulder.y, eyeR.x, eyeR.y)) /
              d) *
            6.6;
          ...
          let shouldersize =
            (p.dist(
              rightShoulder.x - 1.25 * d,
              rightShoulder.y - 1.25 * d,
              leftShoulder.x + 1.25 * d,
              leftShoulder.y - 1.25 * d
            ) /
              d) *
            5.2;
          ...
          let shape = "";
          if (forme2 > 0.97 && forme2 < 1.1) shape = "inverted triangle";
          else if (forme2 > 1.1 && shouldersize > 45) shape = "oval";
          else if (forme > 1.002) shape = "pear";
          else if (forme > 0.77) shape = "rectangle";
          else if (forme < 0.77) {
            shape = "Hourglass";
          }
          ...
          if (user?.result?.gender !== "F") {
            if (random === 35) jeans = 28;
            else if (random === 36) jeans = 29;
            else if (random === 37) jeans = 30;
            else if (random === 38) jeans = 31;
            else if (random === 39) jeans = 32;
            else if (random === 40) jeans = 33;
            else if (random === 41) jeans = 34;
            else if (random === 42) jeans = 35;
            else if (random === 43) jeans = 36;
            else if (random === 44) jeans = 37;
            else if (random > 44) jeans = 38;
            console.log(jeans);
            document.getElementById("jeans").innerHTML = jeans;
          } else {
            console.log(random);
            if (random < 33) jeans = 23;
            else if (random === 33) jeans = 24;
            else if (random === 34) jeans = 25;
            else if (random === 36) jeans = 26;
            else if (random === 37) jeans = 27;
            else if (random === 38) jeans = 28;
            else if (random === 39) jeans = 29;
            else if (random === 40) jeans = 30;
            else if (random === 41) jeans = 31;
            console.log(jeans);
            document.getElementById("jeans").innerHTML = jeans;
          }
          if (user?.result?.gender !== "F") {
            if (random === 31 || random === 32) top = "XS";
            else if (random === 33) top = "S";
            else if (random === 34 || random === 35) top = "M";
            else if (random === 36) top = "L";
            else if (random === 37 || random === 38) top = "XL";
            else if (random === 39) top = "XXL";
            else if (random === 40 || random === 41) top = "XXXL";
            else if (random === 42) top = "4Xl";
            ...
            else if (top === "L") Rp = "XXL";
            else if (top === "XL") Rp = "3XL";
            let sp;
            if (Rp === "M") sp = "L";
            if (Rp === "L") sp = "XL";
            if (Rp === "XL") sp = "XXL";
            ...
            if (shoud === 33 || shoud === 34) top = "XS";
            if (shoud === 36 || shoud === 35) top = "S";
            if (shoud === 37 || shoud === 38) top = "M";
            if (shoud === 39 || shoud === 40) top = "L";
            if (shoud > 40) top = "XL";
            document.getElementById("top").innerHTML = top;
            let R;
            if (top === "XS") R = "S";
    ...
    return (
      <div class="vid">
        ...
        <div class="row">
          ...
          <div class="col">
            {" "}
            <img src={profil} alt="" width="500px"></img>{" "}
          </div>
          <div class="col">
